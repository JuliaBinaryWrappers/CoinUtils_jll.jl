...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CoinUtils_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("be027038-0da8-5614-b30d-e42594cb92df"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CoinUtils", artifacts_toml) for e in artifacts["CoinUtils"]]
...
if best_platform === nothing
    @debug("Unable to load CoinUtils; unsupported platform $(triplet(platform_key_abi()))")
else
