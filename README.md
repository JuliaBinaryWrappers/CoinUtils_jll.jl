# `CoinUtils_jll.jl` (v200.1100.1200+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/53dec853151b42d1f3acb647279cd138f68fc659/C/Coin-OR/CoinUtils/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/coin-or/CoinUtils.git (revision: `cc644574ef1899f14b7318e6cdb7f460bbee5212`)
